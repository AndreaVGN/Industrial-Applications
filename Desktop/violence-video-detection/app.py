...
# CORE INFERENCE
# ===============================
def run_video_inference(video_path, save_out=True):
...
async def process_video(
    ...
    violence, frames, inf_ms = run_video_inference(in_path, save_out=False)
